...
import {AirplaneData, AirportData} from "../../../assets/static/TableDataTypes";
...
const FlightForm = () => {
    ...
    const saveFlight = (input: InputFlight, id: string | undefined) => {
        if (id === undefined) {
            axios.post(`${API_URL}/v1/flights`, input)
                .then(({data}) => {
            ...
            axios.put(`${API_URL}/v1/flights/${id}`, input)
                .then(({data}) => {
                    // Toast
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (id && !selectedFile) {
            ...
            axios.post(`${API_URL}/v1/images/upload`, formData)
                .then(({data}) => {
    ...
    useEffect(() => {
        ...
        if (id !== undefined) {
            axios.get(`${API_URL}/v1/flights/${id}`)
                .then(({data}) => {
    ...
    return (
        <Layout>
            ...
            <div className="w-full px-4 py-6 xl:px-8 xl:py-10 2xl:px-10">
                <p className="text-[#1E90FF] font-semibold text-xl">{id !== undefined ? "Edit Flight" : "Add Flight"}</p>
                    ...
                    <section className="w-full pt-6 mt-8 border-t-4">
                        <div className="flex flex-col w-full gap-y-6">
                            ...
                            <div className="flex flex-col w-full">
                                <label htmlFor={"sourceAirportId"} className="text-xl font-bold">
                                    Airport Source
                                </label>
                                <select
                                ...
                                >
                                    ...
                                    {airportList.map((data) => (
                                        <option value={data.id}>{data.name} ({data.cityCode})</option>
                                    ))}
                                </select>
                            </div>
                            ...
                            {/*Destination Airport*/}
                            <div className="flex flex-col w-full">
                                <label htmlFor={"destinationAirportId"} className="text-xl font-bold">
                                    Airport Destination
                                </label>
                                <select
                                    className="select select-bordered w-4/5 rounded-lg border-2 border-[#B7B7B7] mt-4 py-2 px-2 bg-white"
                            ...
                            <div className="flex flex-col w-full">
                                <label htmlFor={"destinationTerminal"} className="text-xl font-bold">
                                    Destination Terminal
                                </label>
                                <input
                                    type="text"
                            ...
                            {/*Economy seats price*/}
                            <div className="flex flex-col w-full">
                                <label htmlFor={"economySeatsPrice"} className="text-xl font-bold">
                                    Economy Seat Price
                                </label>
                                <input
                                    type="number"
                            ...
                            <div className="flex flex-col w-full">
                                <label htmlFor={"businessSeatsPrice"} className="text-xl font-bold">
                                    Business Seat Price
                                </label>
                                <input
                                    type="number"
                            ...
                            {/*First seats price*/}
                            <div className="flex flex-col w-full">
                                <label htmlFor={"firstSeatsPrice"} className="text-xl font-bold">
                                    First Seat Price
                                </label>
                                <input
                                    type="number"
                            ...
                            <div className="flex flex-col w-full">
                                ...
                                <input
                                    ...
                                    name={"thumbnailUrl"}
                                    id={"thumbnailUrl"}
                                    className="file-input file-input-bordered w-4/5 mt-4 "
