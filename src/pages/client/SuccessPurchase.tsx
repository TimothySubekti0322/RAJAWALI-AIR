  ...
  return (
    <section className="w-full min-h-screen bg-[#f7f7f7] relative text-white">
      <HeaderLayout>
        <HeaderFillPurchase
          orderId={"123455"}
          paymentBy={"Mandiri Virtual Account"}
        />
      </HeaderLayout>
      <BodyLayout paddingBottomSize={"0"}>
        <div
          ...
          style={{
            backgroundImage: `url(${frame001Png})`,
        ...
        >
          <div className={"mb-3 flex justify-between"}>
            <div className={"flex flex-col justify-between"}>
              ...
              <p className={"text-[10px] text-[#505050]"}>
                Your transaction has been successful, Cool! Please check the
                transaction receipt!
              </p>
            </div>
          ...
          <div className={"rounded-lg bg-white flex flex-col pb-16 mb-3"}>
            ...
            <div
              className={
                "w-full rounded-t-lg flex px-4 py-3 bg-[#EDEDED] justify-between"
              }
            >
            ...
            <div className={"flex flex-col gap-4"}>
              ...
              <div
                className={
                  "flex flex-col items-center justify-center pt-3 text-black gap-4"
                }
              >
          ...
          <button
            className={
              "btn btn-side w-full bg-[#1E90FF] text-white hover:bg-blue-700"
            }
            onClick={() => {
