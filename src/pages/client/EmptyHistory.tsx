    ...
    return(
        <section className="w-full min-h-screen bg-[#f7f7f7] relative">
            ...
            <BodyLayout paddingBottomSize="5rem">
                <div className="flex flex-col space-y-2 p-4 place-content-center">
                    <img src="/images/history-empty.svg" alt="" />
                    <p className="font-bold text-black text-center">
                    You haven’t book any orders yet
                    </p>

                    <p className="text-black text-center">
                    All your past flight ticket bookings will be displayed here. Plan your journeys with us.
                    </p>
                </div>
            </BodyLayout>
