      ...
      <div className="container grid gap-4 grid-cols-2 min-[320px]:grid min-[320px]:grid-cols-1 sm:container sm:mx-auto sm:items-center sm:grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2 pt-[0%]">
        ...
        <div className="mr-[5.06rem] sm:items-center sm:mx-6">
          ...
          <div className="flex mt-7">
            <div className="flex-initial mr-[1.06rem] w-11 h-11 p-2 bg-blue-500 rounded-full justify-center items-center inline-flex mt-4">
              <img src="/images/carbon_request-quote.png" alt="" />
            </div>
            <div className="flex-1 w-32 ">
              <p className="w-96 h-6 text-neutral-600 text-base font-bold font-['Open Sans'] leading-snug text-justify">
          ...
          <div className="flex mt-7">
            ...
            <div className="flex-1 w-32">
              ...
              <p className="text-black">
                Allows you to book complete routes involving multiple cities or
                layovers
              </p>
            </div>
          </div>
          ...
          <div className="flex mt-7">
            ...
            <div className="flex-1 w-32">
              ...
              <p className="text-black">
                We have fast-response call center that will help you anytime you
                need (24/7 hours)
              </p>
            </div>
          </div>
          ...
          <div className="flex mt-7">
            <div className="flex-initial mr-[1.06rem] w-11 h-11 p-2 bg-blue-500 rounded-full justify-center items-center inline-flex mt-2">
              <img src="/images/ion_notifications-outline.png" alt="" />
            </div>
            <div className="flex-1 w-32">
              <p className="w-96 h-6 text-neutral-600 text-base font-bold font-['Open Sans'] leading-snug text-justify">
              ...
              <p className="text-black">
                Keep you informed about delays, cancellations, and gate changes.
              </p>
            </div>
          </div>
        </div>
