          ...
          <Collapse in={expanded1} timeout="auto" unmountOnExit>
            ...
            <CardContent sx={{ padding: 0, margin: 0 }}>
              <Typography sx={{ margin: 0, marginTop: 3 }} paragraph>
                <div className="mt-2 text-xs text-black 2xl:text-sm">
                  <ol>
                    <li>masi kosong</li>
                  </ol>
                </div>
                ...
                <div className="mt-2 text-xs text-black 2xl:text-sm">
                  <ol>
                    ...
                    <li>
                      ...
                      , eg.{" "}
                      <span className="font-semibold">780 0112 5785 8072</span>{" "}
                      <span className="block ml-2.5">
                        as{" "}
                        <span className="font-semibold">
                          No. Virtual Account
                        </span>
                    ...
                    <li>
                      5. Click <span className="font-semibold">Lanjutkan</span>{" "}
                      dan <span className="font-semibold">Kirim</span>
                    </li>
                    <li>
                      6. <span className="font-semibold">Payment receipt</span>{" "}
                      displayed
                    </li>
